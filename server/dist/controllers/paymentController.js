...
exports.splitPaymentHandler = exports.verifyPaymentHandler = void 0;
...
// @access Private 
// ================================================
const splitPaymentHandler = async (req, res) => {
    ...
    try {
        ...
        const vendorShares = cartProducts.reduce((acc, product) => {
        ...
        const vendors = await Vendor_1.default.findAll({ where: { id: vendorIds } });
        // Calculate fees
        ...
        const totalVendorShare = Object.values(vendorShares).reduce((sum, share) => sum + share, 0);
        // Build payout records for each vendor
        // Loops through each vendor fetched earlier to calculate and prepare their payout
        const payoutRecords = vendors.map((vendor) => {
        ...
        // Save payout record
        await VendorPayout_1.default.bulkCreate(payoutRecords);
        // Log payout records
...
exports.splitPaymentHandler = splitPaymentHandler;
