...
exports.getProductsByVendorIdHandler = exports.deleteProductHandler = exports.updateProductHandler = exports.getProductByIdHandler = exports.getProductsHandler = exports.createProductHandler = void 0;
...
const createProductHandler = async (req, res) => {
    try {
        ...
        if (!name || !price || !CategoryId || !stock) {
            res.status(400).json({ message: 'All fields (name, price, CategoryId, stock) are required' });
            return;
        }
        ...
        if (existingProduct) {
            res.status(400).json({ message: 'A product with this name already exists for this vendor and category' });
            return;
        }
        // Create the product
